...
// Rotas
	...
	router.get('/notes/cadastro', middleware.authenticated, Rota.addForm); // Formulário de cadastro de anotação
	router.get('/notes/update/:id', middleware.authenticated, Rota.getUpdateForm); // Formulário de atualização de anotação
	router.get('/notes/delete/:id', middleware.authenticated, Rota.getDeleteForm); // Confirmação se deseja deletar anotação
